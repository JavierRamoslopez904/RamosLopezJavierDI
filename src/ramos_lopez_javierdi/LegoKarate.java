 ...
 * @author javie
 */
public class LegoKarate extends javax.swing.JFrame {

    /**
     * Creates new form LegoKarate
     */
    public LegoKarate() {
        initComponents();
        setLocationRelativeTo(null);
        setTitle("LEGO KARATEKA");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LegoKarate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LegoKarate().setVisible(true);
            }
        });
    }
