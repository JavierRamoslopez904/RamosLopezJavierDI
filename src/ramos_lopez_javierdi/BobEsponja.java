 ...
 * @author javie
 */
public class BobEsponja extends javax.swing.JFrame {

    /**
     * Creates new form BobEsponja
     */
    public BobEsponja() {
        initComponents();
        setLocationRelativeTo(null);
        setTitle("BOB ESPONJA");
    }
    ...
    /**
     * Método que volverá a la página principal
     * @param evt 
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BobEsponja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BobEsponja().setVisible(true);
            }
        });
    }
