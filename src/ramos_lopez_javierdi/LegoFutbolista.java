 ...
 * @author javie
 */
public class LegoFutbolista extends javax.swing.JFrame {

    /**
     * Creates new form LegoFutbolista
     */
    public LegoFutbolista() {
        initComponents();
        setLocationRelativeTo(null);
        setTitle("LEGO FUTBOLISTA");
    }
    ...
    private void initComponents() {
        ...
        fifthButton.setText(org.openide.util.NbBundle.getMessage(LegoFutbolista.class, "Vendido.fifthButton.text")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LegoFutbolista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LegoFutbolista().setVisible(true);
            }
        });
    }
